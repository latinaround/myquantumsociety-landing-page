          ...
          <Fade direction="up" delay={200} triggerOnce>
            <div className="sm:w-[65%] mx-auto mb-9">
              <p className="text-xl font-light">
                Moving from the computational space consisting of two points &lbrace;0, 1&rbrace; to the space of infinitely many points gives a huge advantage of encoding and processing information.
              </p>
