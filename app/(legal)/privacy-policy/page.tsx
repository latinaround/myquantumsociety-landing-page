    ...
    <main className="w-full" style={{ backgroundColor: "var( oklch(var(--bc) / 1))" }}>
      ...
      <div className="min-h-screen p-6">
        <div className="container mx-auto text-left text-sm">
          ...
          <h2 className="text-lg font-bold mt-6">2. Information We Collect</h2>
          ...
          <h2 className="text-lg font-bold mt-6">3. How We Collect Information</h2>
          ...
          <h2 className="text-lg font-bold mt-6">4. Use of Information</h2>
          ...
          <h2 className="text-lg font-bold mt-6">5. Sharing of Information</h2>
          ...
          <h2 className="text-lg font-bold mt-6">6. Cookies and Tracking Technologies</h2>
          ...
          <h2 className="text-lg font-bold mt-6">7. Data Security</h2>
          ...
          <h2 className="text-lg font-bold mt-6">8. Data Retention</h2>
          ...
          <h2 className="text-lg font-bold mt-6">9. User Rights</h2>
          ...
          <h2 className="text-lg font-bold mt-6">10. Children’s Privacy</h2>
          ...
          <h2 className="text-lg font-bold mt-6">11. Changes to this Privacy Policy</h2>
          ...
          <h2 className="text-lg font-bold mt-6">12. Contact Information</h2>
